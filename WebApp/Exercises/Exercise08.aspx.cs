    ...
    public partial class Exercise08 : System.Web.UI.Page
    {
        ...
        protected void BindList()
        {
            try
            {
                ...
                info = sysmgr.List();
                info.Sort((x, y) => x.PlayerFullName.CompareTo(y.PlayerFullName));
                List01.DataSource = info;
                List01.DataTextField = nameof(Player.PlayerFullName);
        ...
        protected void Fetch_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    Response.Redirect("~/Pages/96CRUDPageFSIS.aspx?page=08&pid=" + playerid + "&add=" + "no");
                }
                catch (Exception ex)
                {
                    MessageLabel1.Text = ex.Message;
        ...
        protected void Add_Click(object sender, EventArgs e)
        {
            ...
            {
                string playerid = List01.SelectedValue;
                Response.Redirect("~/Pages/96CRUDPageFSIS.aspx?page=08&pid=" + playerid + "&add=" + "yes");
            }
            catch (Exception ex)
            {
                MessageLabel1.Text = ex.Message;
